...
\subsection{Ablation Study 4: Thread Synchronization Overhead}
...
\begin{equation}
    \text{Average Idle Time per Barrier Entry} = \frac{T_{idle}}{C \times N}
...
\subsection{Ablation Study 5: Impact of Fixed Clue Density(F\%) to Solvers' Performance}
